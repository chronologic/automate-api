...
//     '0xf8633c843b9aca0082520894453d2f6893c06131b498091a0e06ee2426f59b91808025a0a1c2caa7e87a4870926d4f94245e1b341ad72da94836406eec590e1c38252f0aa02de28f002047e3427d990035e11041e6c8c024c691925ae596c0bf4ae9b71f82';
//   // const tx = new Scheduled();
//   // tx.signedTransaction = signedTransaction;
//   const tx = await Scheduled.findOne({
//     signedTransaction,
//   }).exec();
//   console.time('txMeta');
//   const txMeta = await ethUtils.fetchTransactionMetadata(tx);
//   console.log(txMeta);
//   console.timeEnd('txMeta');
//   console.time('assMeta');
//   const assetMeta = await ethUtils.fetchAssetMetadata(tx);
//   console.log(assetMeta);
//   console.timeEnd('assMeta');
